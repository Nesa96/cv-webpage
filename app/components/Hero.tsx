        ...
        <div className="flex flex-row items-center justify-center min-h-[80vh] mx-20">
            ...
            <div className="flex flex-col justify-center w-1/3 ">
                ...
                <div className="flex flex-row p-3 text-center text-gray-800 gap-6">
                    <Link href="/resume" className="tech-text border-2 border-dashed border-gray-900 rounded-full p-3 w-1/4 hover:text-gray-300 transition-colors">
                        Resume
                    </Link>
                    <Link href="/projects" className="tech-text border-2 border-dashed border-gray-900 rounded-full p-3 w-1/4 hover:text-gray-300 transition-colors">
                        Projects
                    </Link>
                    <Link href="/skills" className="tech-text border-2 border-dashed border-gray-900 rounded-full p-3 w-1/4 hover:text-gray-300 transition-colors">
                        Skills
                    </Link>
                </div>
            </div>
            <div className="fixed top-20 left-15 z-50 flex items-center gap-3 bg-white/30 backdrop-blur-md border border-dashed border-gray-300 px-4 py-2 rounded-full shadow-sm">
